...
def setup(sim):
    ...
    # 
    biophys = CLBacterium(sim, jitter_z=False, periodic=True, N_x = 1, N_y = 1, grid_spacing=15.0, max_cells = 128)
    ...
    biophys.addPlane((0, 15.0, 0), (0,-1,0), planeWeight) 		# top
    ...
    sim.addCell(cellType=0, pos=(5, 7.5, 0), dir=(1, 0, 0)) 
    sim.addCell(cellType=1, pos=(10, 7.5, 0), dir=(1, 0, 0)) 
