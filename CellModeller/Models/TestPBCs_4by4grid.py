...
def setup(sim):
    ...
    # 
    biophys = CLBacterium(sim, jitter_z=False, periodic=True, N_x = 4, N_y = 4, max_cells = 2**11, max_contacts = 16)
    ...
    sim.addCell(cellType=0, pos=(5, 10, 0)) 
    sim.addCell(cellType=1, pos=(15, 10, 0)) 
